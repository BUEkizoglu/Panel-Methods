...
This Pluto notebook contains a numerial tool created to calculate the lift around a NACA $4$-digit series foil using potential theory and vortex panel method. This notebook explains the methodology briefly and contains the tool. The methodology is explained in great detail in another Pluto notebook called `NACA_XXXX_PM_validation_convergence.jl` which is designes as an extension. It includes step by step explanation of the code development steps, extensive convergence studies and will be extended in the future to include an analytical or experimental validation case as well. 
...
begin
	CamberS = @bind camber Slider(0.0:1:20, default=15, show_value=true)
...
begin
	Rotation_AngleS = @bind angle_deg Slider(-30:1:30, default=0, show_value=true)
...
# ╔═╡ c0f77c2c-918f-451a-9e69-61ebc045ad5d
md"""
...
## 5.2. Implementation of Vortex Panel Method
...
### 5.2.1. Assembling and Solving the Matrix Equation System
...
# ╔═╡ 9118a6a3-e691-47ed-8749-d95672e1cd67
begin
